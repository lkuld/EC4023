...
*This tutorial is a very brief introduction to the basics of probability distribution and statistical tests. It is a complement to the lectures and not a replacement. In parts, it goes further than the lecture, and for your exam, only material discussed in the lectures is relevant. The tutorial is a rapid succession of complex concepts, it is okay and maybe expected to not understand parts of it. The aim is to get a better intuition how statistical tests work.*
